...
urlpatterns = [
  ...
  path("collective/create", views.create, name="create"),
  ...
  path("api/collective", views.apicollective, name="apicollective"),
  ...
  path("api/correct/<int:_answer>/<str:_bool>", views.apicorrect, name="apicorrect"),
